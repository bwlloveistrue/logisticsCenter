...
public class OrderTakerSplitPage extends SplitPageInterface {
    ...
    public List<PageCell> createColumn() {
        ...
        pageCell = new PageCell("出发日期","beginDate","beginDate","10%",false,false);
        pageCellList.add(pageCell);

        pageCell = new PageCell("状态","orderStatusName","orderStatusName","10%",false,false);
        pageCellList.add(pageCell);

        pageCell = new PageCell("是否包车","packageFlgShow","packageFlgShow","15%",false,false);
        pageCellList.add(pageCell);

        pageCell = new PageCell("创建日期","createDate","createDate","10%",false,false);
        pageCellList.add(pageCell);
        return pageCellList;
    }
